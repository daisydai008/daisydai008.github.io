...
%\birth{199x}
% \homepage{https://daisydai008.github.io/my-website/}
\extrainfo{\href{https://daisydai008.github.io/my-website/}{personal website}}
\github{daisydai008}
%\linkedin{username}
%\gitlab{gitlab-id}
...
\input{cv/Volunteer Services.tex}
\input{cv/Self-Evaluation.tex}
%-------------------------------------------------------------------------------
\end{document}

...
% Allow better page breaking for long content
\allowdisplaybreaks
\raggedbottom
  ...
  \cventry
    ...
    {Sep. 2024 -- Mar. 2025} % Date
    {
      ...
      \begin{cvitems}
        ...
        \item{\textbf{Robot Kinematics \& Control:} Implemented kinematic modeling and mapping algorithms to reconstruct operator motion. Created Unity3D-based for real-time teleoperation of dual-arm JAKA robots and DexHand 021 systems}
      \end{cvitems}
    }
    \cventry
